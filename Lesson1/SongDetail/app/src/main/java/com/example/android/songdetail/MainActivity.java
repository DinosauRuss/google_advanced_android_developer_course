            ...
            holder.mView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    if (mTwoPane) {
                        ...
                        SongDetailFragment frago = SongDetailFragment.newInstance(selectedSong);
                        getSupportFragmentManager().beginTransaction()
                                .replace(R.id.song_detail_container, frago)
                                .addToBackStack(null)
                                .commit();
                    } else {
                        Context contexto = view.getContext();
                        Intent intent = new Intent(contexto, SongDetailActivity.class);
